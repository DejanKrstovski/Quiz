...
/**
 * Represents a quiz question with an associated theme, a title, the question
 * text, and possible answers.
 * <p>
 * Designed to be persisted via {@link DataAccessObject}.
 * </p>
 * <p>
 * Equality and hash code are based on the {@code title} field, which should be
 * unique per question.
 * </p>
 * 
 * @author
...
public class QuestionDTO extends DataTransportObject {
	 ...
	 * 
	 * @return the {@link ThemeDTO} associated with this question
	 */
	 ...
	 * 
	 * @param theme the {@link ThemeDTO} to associate with this question
	 */
	 ...
	 * @return {@code true} if both are {@code Question} instances having the same
	...
	/**
	 * Returns a hash code value for this question based on its unique identifier
	 * (id).
	 * <p>
	 * This implementation returns the value of {@code getId()} directly, so equal
	 * IDs will produce the same hash code.
	 * </p>
	 *
